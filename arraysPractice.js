...
var divider = function(numbersArray) {
    ...
    var newNumbersArray = [];
    newNumbersArray.push(evenArray, oddArray);
...
var finder = function(x) {
    return x.indexOf(getRandomArbitrary()) > -1;
};
...
var removeItem = function(arg1, arg2) {
if (Array.isArray(arg1) && typeof arg2 === 'string') {

        var myArray = arg1;
        var index = myArray.indexOf(arg2);
        if (index > -1) {
...
var removeCahlan = function (arr1) {
    for (i=0; i<arr1.length; i++) {
        if (arr1[i] == cahlan) {
            arr1.splice(i, 1);
        }
...
var removeTyler = function (arr1) {
    for (i=0; i<arr1.length; i++) {
        if (arr1[i].email == "tylermcginnis33@gmail.com") {
            arr1.splice(i, 1);
        }
        return arr1;
    }
